...
export default function Ana2ByProdParty(props) {
                ...
                <table className="table table-bordered" cellSpacing="0" style={{ width: "100%" }}>
                    <thead>
                        <tr style={{ fontSize: "12px" }}>
                            <th className="bg-color col-xs-3 text-left">Product/Party</th>
    ...
    function isLastG1(index) {
        ...
        return index === lastIndex || transarray[index].ProductId !== transarray[index + 1].ProductId

    }

    function isNewG1(index) {
        return index === 0 || transarray[index].ProductId !== transarray[index - 1].ProductId
    }
