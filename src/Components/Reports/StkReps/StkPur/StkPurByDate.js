...
export default function StkPurByDate(props) {
            ...
            return (
                <tr>
                    <td colSpan={11} style={{ textAlign: "center" }}>
                        <div style={{ background: "lightgrey", color: "#000", width: "300px", padding: "5px 0", textTransform: "uppercase", margin: "0 auto", fontSize: "16px", fontWeight: "bold" }}>
        ...
        if (index === transarray.length - 1) { //Last Row
            return (
                <tr>
                    ...
                    <td colSpan={1} className="bold right"><Currency value={grand_pbal} /></td>
                    <td colSpan={1} className="bold right"><Currency value={grand_bal} /></td>
                    <td colSpan={1} className="bold right"><Currency value={grand_bal !== 0 ? grand_net_amt / grand_bal : null} /></td>
                    <td colSpan={1} className="bold right"><Currency value={grand_bal_amt} /></td>
                    <td colSpan={1} className="bold right"><Currency value={grand_net_amt} /></td>
                </tr>
            )
        }
    }
