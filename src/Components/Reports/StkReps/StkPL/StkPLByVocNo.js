...
export default function StkPLByDate(props) {
            ...
            <tr className="entry_row statement_row">
                ...
                <td style={{ textAlign: "center", maxWidth: "30" }}>
                    <span style={{ color: "#036", textTransform: "uppercase" }}>
                        <a href={'sale/' + data.VocNo}>{data.VocNo}</a>
                    </span>
                </td>
                <td style={{ textAlign: "left" }}>
                ...
                <td style={{ textAlign: "right" }}>
                    <span style={{ borderRadius: "2px", color: "#036" }}>
                        <Currency value={data.PLRate} />
                    </span>
                </td>
                <td style={{ textAlign: "right" }}>
                    <span style={{ borderRadius: "2px", color: "#036" }}>
                        <Currency value={data.CostAmt>0 ? (data.PLAmt/data.CostAmt*100).toFixed(2) : 0} />%
                    </span>
                </td>
            </tr>
        )
    ...
    function isLastG1(index) {
        ...
        return index === lastIndex || transarray[index].VocNo !== transarray[index + 1].VocNo

    }

    function isNewG1(index) {
        return index === 0 || transarray[index].VocNo !== transarray[index - 1].VocNo
    }
