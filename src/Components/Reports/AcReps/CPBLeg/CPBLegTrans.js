...
export default function CPBLegTrans({transarray}) {
                ...
                <table className="table table-bordered" cellSpacing="0" style={{ width: "100%" }}>
                    <thead>
                        <tr className="report_cpb_bal_th" style={{ fontSize: "12px" }}>
                            <th className="bg-color text-center col-xs-1 cpb_bal_th_cpbno">CPB</th>
                            <th className="bg-color text-center col-xs-1 cpb_bal_th_cpbno">VocNo</th>
                            <th className="bg-color text-center col-xs-1 cpb_bal_th_cpbno">TType</th>
                            <th className="bg-color text-center col-xs-1 cpb_bal_th_date">Date</th>
                            <th className="bg-color text-center col-xs-1 cpb_bal_th_date">ChqNo</th>
                            <th className="bg-color text-center col-xs-1 cpb_bal_th_date">ChqDate</th>
                            <th className="bg-color text-left col-xs-2 cpb_bal_th_partyname">Party Name</th>
                            <th className="bg-color col-xs-1 text-left cpb_bal_th_bank">Bank</th>
                            <th className="bg-color col-xs-1 text-right cpb_bal_th_amount">ChqAmt</th>
                            <th className="bg-color col-xs-1 text-right cpb_bal_th_amount">RecAmt</th>
                            <th className="bg-color col-xs-1 text-right cpb_bal_th_amount">TransIss</th>
                            <th className="bg-color col-xs-1 text-right cpb_bal_th_amount">TransRec</th>
                            <th className="bg-color col-xs-1 text-right cpb_bal_th_amount">Balance</th>
                            <th className="bg-color col-xs-3 text-left cpb_bal_th_issueto">IssueTo</th>
                        </tr>
                    </thead>
                    <tbody>
                        {
