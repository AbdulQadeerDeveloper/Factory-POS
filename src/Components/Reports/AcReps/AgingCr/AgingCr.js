...
import AgingCrTrans from "./AgingCrTrans";
...
export default function AgingCr() {
  //#region variables
  ...
  function GenerateReport() {
    ...
    var config = {
      method: "GET",
      url: `api/fin/cr_aging?edate=${eDateRef.current.value}${cri}`,
    };
    axios(config)
      .then((response) => {
    ...
    <AnimatedPage className="container-fluid main_container">
      <div className="main-div">
        ...
        <div className="printing_area" ref={componentRef}>
          <br />
          <AgingCrTrans transarray={ftransarray} />
        </div>
      </div>
    </AnimatedPage>
  );
