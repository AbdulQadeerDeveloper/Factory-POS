...
export default function Trial6Col({ componentRef, parentobj, transarray }) {
            ...
            <table cellSpacing="0" style={{ width: "100%" }}>
              <thead>
                ...
                <tr className="table table-bordered">
                  ...
                  <th className="bg-color col-xs-1 text-right" style={{ width: '12%' }}>Op Dr</th>
                  <th className="bg-color col-xs-1 text-right" style={{ width: '12%' }}>Op Cr</th>
