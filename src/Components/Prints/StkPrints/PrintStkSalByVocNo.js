...
export default function PrintStkSalByVocNo({
  parentobj,
  componentRef,
  transarray
}) {
  ...
  return (
    <div className="container newprint">
      <div ref={componentRef}>
        ...
        <table cellSpacing="0">
          <thead>
            <ReportHead colspan={11} title={`Sales By VocNo`} />
  ...
  function DataRow({ data }) {
    ...
    return (
      <tr className="light-border normal">
        ...
        <td className="center"> <ConvertedDate date={data.Date} /></td>
  ...
  function isLastG1(index) {
    ...
    return (
      index === lastIndex ||
      transarray[index].VocNo !== transarray[index + 1].VocNo
    );
  }
