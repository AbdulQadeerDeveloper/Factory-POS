...
function PRV() {
  ...
  return (
    <AnimatedPage>
      ...
      <div className="clearfix"></div>
      {parentobj.VocNo > 0 && <InvStats ttype={4} vocno={id} /> }
    </AnimatedPage>
  );
}
